    ...
    return(
        ...
        <div className="main_slider_cont">
            ...
            <div className='details-shipping'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-rocket-takeoff" viewBox="0 0 16 16">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
                    ...
                    <div>
                        <h5>Get 20% off 1 itemg</h5>
                        <p>When you sign up</p>
                    </div>
                </div>

                <div className='details'>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-emoji-heart-eyes-fill" viewBox="0 0 16 16">
